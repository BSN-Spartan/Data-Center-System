...
INSERT INTO `sys_message_template` (`msg_code`, `msg_title`, `msg_content`, `msg_type`, `update_time`, `create_time`,
                                    `state`)
VALUES ('user_join_captcha_', 'BSN Spartan Data Center Notification: ${captcha_} is your verification code',
        'Thank you for choosing BSN Spartan Network!<br/>\r\n<b>${captcha_}</b> is your verification code! This code is only valid for ${minutes_} minutes, if you request a new code, this code will no longer be valid.\r\n',
        2, now(), now(), 1);
INSERT INTO `sys_message_template` (`msg_code`, `msg_title`, `msg_content`, `msg_type`, `update_time`, `create_time`,
                                    `state`)
VALUES ('gas_recharge_captcha_', 'BSN Spartan Data Center Notification: ${captcha_} is your verification code',
        'Thank you for choosing BSN Spartan Network!<br/>\r\n<b>${captcha_}</b> is your verification code! This code is only valid for ${minutes_} minutes, if you request a new code, this code will no longer be valid.\r\n',
        2, now(), now(), 1);
INSERT INTO `sys_message_template` (`msg_code`, `msg_title`, `msg_content`, `msg_type`, `update_time`, `create_time`,
                                    `state`)
...
INSERT INTO `sys_message_template` (`msg_code`, `msg_title`, `msg_content`, `msg_type`, `update_time`, `create_time`,
                                    `state`)
VALUES ('keyStorePasswordReset', 'Data Center System Notification: Re-configure Keystore Password',
        'After restarting the service of Data Center Management System, please configure the keystore password again. Otherwise, the system cannot submit transactions to the chain.<br/><br/>
            <b>Operation step</b>：Click "Configuration" button and enter the keystore password in Keystore Password section.',
        '2', now(), now(), '1');
