...
You can Top-up Gas Credit through your management system. Please make sure that the target Wallet is correctly. If the target Wallet is incorrect but the transaction is successfully executed, the transaction can not be rolled back.

**Log in to the BSN Spartan Data Center Software, click on "Gas Credit Management" on the panel and open the page:**
...
If you are very familiar with the use of blockchain and smart contracts, you can also choose to directly call our official smart contract for Gas Credit Top-up.
...
> <font color=red>If Top-up Failed.</font>**Please make sure your NTT is correctly refunded.**
