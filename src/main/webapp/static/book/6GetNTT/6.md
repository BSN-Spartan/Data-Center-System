...
Please note that it can only be collected once a day, if you have additional needs, please feel free to contact us.

Visit https://spartan.bsn.foundationand select **"Get NTT For Free"**:


<img src='img/getntt1.png' style='width:600px;' alt='getntt1' title='getntt1'>

- **Click "Get NTT" button:**

<img src='img/getntt2.png' style='width:600px;' alt='getntt2' title='getntt2'>

- Enter NTT Wallet address；
