...
After registering in the Spartan Node Management Contract, you will be able to normally receive incentives from the NTT economic system and potential various rewards from the Spartan Foundation. And you can also monitor the status of the node at any time in your Data Center Management System.
...
Use your Data Center Management System for node registration, and the management system will call the Spartan Node Management Contract to register your node information on the chain. Choose NC Ethereum as the target chain.

**Log in to the BSN Spartan Data Center Software, click on "Node Management"-> "Node Info" on the panel and open the page:**
...
- Enter the RPC URL, you can monitor the status of the node at any time in your Data Center Software；

- Supply the key store password；

- Click the **"Submit"** button, the backend timing task will submit the node information to the chain directly and wait for the chain to carry out the Node Registration Test, we will send the result to the Data Center’s email address. 
...
**Log in to the BSN Spartan Data Center Software, click on "Home" on the panel and open the page, check your NTT Balance.**


<img src='img/NTTBalance.png' style='width:600px;' alt='NTTBalance' title='NTTBalance'>

**You can also click "NTT History" to view the page:**
